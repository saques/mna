...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.putText(img, "Hello World!!!", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), thickness=2)
        cv2.putText(img, "Hello World!!!", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), thickness=1)
    ...
    if cv2.waitKey(1) & 0xFF == ord('s'):
        ...
        cv2.imwrite("saved_face.pgm", face)

        print clf.predict(kpca.project_images(np.ravel(face)))
